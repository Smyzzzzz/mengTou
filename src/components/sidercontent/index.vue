    ...
    <div class="configurator">
      <SectionWrapper :title="t('label.wrapperShape')">
        <div class="wrapper-shape">
          <div v-for="wrapperShape in SETTINGS.wrapperShape" :key="wrapperShape" class="wrapper-shape__item"
            :title="t(`wrapperShape.${wrapperShape}`)" @click="switchWrapperShape(wrapperShape)">
      ...
      <SectionWrapper :title="t('label.backgroundColor')">
        <div class="color-list">
          <div v-for="bgColor in SETTINGS.backgroundColor" :key="bgColor" class="color-list__item"
            @click="switchBgColor(bgColor)">
            <div :style="{ background: bgColor }" class="bg-color" :class="{
